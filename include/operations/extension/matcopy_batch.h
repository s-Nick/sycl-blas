...
template <blas::matcopy_op op, int TileSize, bool trans_rhs_1, typename lhs_t,
          typename rhs_t>
Matcopy_batch<op, TileSize, trans_rhs_1, lhs_t, rhs_t> make_matcopy_batch(
  ...
  return Matcopy_batch<op, TileSize, trans_rhs_1, lhs_t, rhs_t>(
